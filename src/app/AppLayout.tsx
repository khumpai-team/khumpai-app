...
export function AppLayout() {
  ...
  return (
    <div className="device-backdrop grain relative flex min-h-[100dvh] items-center justify-center sm:p-6">
      <div
        id="app-frame"
        className="relative flex h-[100dvh] w-full max-w-phone flex-col overflow-hidden bg-bg-base sm:h-[860px] sm:max-h-[calc(100dvh-48px)] sm:rounded-[44px] sm:border sm:border-border sm:shadow-soft-xl"
      >
        <NotificationCenter />
